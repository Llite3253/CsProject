...
<body class="simple_join_body">
    <div class="simple_join_main">
        ...
        <form class="container" action="/member/entrepreneur_join" method="post">
            <input type="hidden" class="Entreperneur" value="1">
            <div class="simple_join_container">
                ...
                <hr>
                <div class="email_join_div">
                    <div class="email_join_text">회사명</div>
                    <div class="email_join_input1">
                        <div class="email_join_input2 email_join_input2_E_name">
                            <input type="text" name="entrepreneur_name" placeholder="회사명 입력" class="email_join_input_String email_join_input_String-E_name">
                            <a onclick="x_Delete('.email_join_input_String-E_name', '.email_join_input2_x-E_name')" class="email_join_input2_x email_join_input2_x-E_name"><img src="/img/login/x.png" class="email_join_input_img"></a>
                        </div>
                    </div>
                    <div class="email_join_err_String email_join_err_String-E_name"></div>
                </div>
                <div class="email_join_div">
                    <div class="email_join_text">대표자명</div>
                    <div class="email_join_input1">
                        <div class="email_join_input2 email_join_input2_C_name">
                            <input type="text" name="company_name" placeholder="대표자명 입력" class="email_join_input_String email_join_input_String-C_name">
                            <a onclick="x_Delete('.email_join_input_String-C_name', '.email_join_input2_x-C_name')" class="email_join_input2_x email_join_input2_x-C_name"><img src="/img/login/x.png" class="email_join_input_img"></a>
                        </div>
                    </div>
                    <div class="email_join_err_String email_join_err_String-C_name"></div>
                </div>
                <hr>
